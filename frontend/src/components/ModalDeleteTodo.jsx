...
const ModalDeleteTodo = () => {
    const { modalDeleteTodo, handleModalDeleteTodo, todo, deleteTodo } = useProject()
    return (
        <Transition.Root show={modalDeleteTodo} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleModalDeleteTodo}>
