...
const FormCollaborator = () => {
    ...
    return (
        <>
            <form className='mb-5 bg-gray-700 py-10 px-5 md:w-2/3 rounded-lg mx-auto mt-10' onSubmit={handleSubmit} onChange={() => handleAlert({})}>
                ...
                <div className='flex w-[90%] mx-auto'>
                    ...
                    <input type="submit" className='bg-transparent border-2 mt-2 border-pink-300 py-3 w-2/3  rounded-lg text-white hover:bg-gray-700 hover:cursor-pointer hover:border-gray-500 transition-colors' value='Look for collaborator' />
                </div>
            </form>
