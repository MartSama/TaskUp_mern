        ...
        <>
            ...
            <form action="" className='my-10 bg-gray-900 text-white shadow rounded-lg py-5 px-10'>
                <div className='my-5'>
                    ...
                    <input className='w-full bg-gray-600 text-sky-500 placeholder-sky-500 py-2 px-2 rounded-lg shadow shadow-gray-400' type="email" id='email' placeholder='yourname@mail.com ...' />
                </div>

                <div className='my-5'>
                    <label className='uppercase text-gray-300 block text-xl mb-3 font-bold' htmlFor="password">Password: </label>

                    <input className='w-full bg-gray-600 text-sky-500 placeholder-sky-500 py-2 px-2 rounded-lg shadow shadow-gray-400' type="password" id='password' placeholder='**********' />
                </div>
